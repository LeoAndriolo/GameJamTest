...
function create() {
  var fundo = this.physics.add.image(300,2400, 'fundo').setScale(4).setVelocityY(-400);// Cria o elemento de fundo
  ...
  var personagem = this.physics.add.image(300, 80, 'personagem').setScale(0.5);//cria o personagem
  ...
  this.physics.add.collider(this.ovni, this.meteoro);
